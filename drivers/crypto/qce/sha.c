...
static int qce_ahash_async_req_handle(struct crypto_async_request *async_req)
{
	...
	{
		pr_err("SHA1\n");
			memcpy(rctx->digest, "\xda\x39\xa3\xee\x5e\x6b\x4b\x0d\x32\x55\xbf\xef\x95\x60\x18\x90\xaf\xd8\x07\x09", SHA1_DIGEST_SIZE);
	}
 		else if (digestsize == SHA256_DIGEST_SIZE)
 		{
			pr_err("SHA2\n");
			memcpy(rctx->digest, "\xe3\xb0\xc4\x42\x98\xfc\x1c\x14\x9a\xfb\xf4\xc8\x99\x6f\xb9\x24\x27\xae\x41\xe4\x64\x9b\x93\x4c\xa4\x95\x99\x1b\x78\x52\xb8\x55", SHA256_DIGEST_SIZE);}
		else
		{
